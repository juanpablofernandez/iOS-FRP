...
class ViewController: UIViewController {
    ...
    var age: Variable<Int> = Variable(25)
    ...
    override func viewDidLoad() {
        ...
        name.asObservable().bindTo(nameLabel.rx.text).addDisposableTo(disposeBag)
        age.asObservable().map { String($0) }.bindTo(ageLabel.rx.text).addDisposableTo(disposeBag)
    }
